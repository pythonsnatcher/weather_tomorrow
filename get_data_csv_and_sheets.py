...
def write_to_google_sheets(data, sheet_name):
    ...
    creds_dict = {
        ...
        f2c31cf7a66d123c4177f73f04fd01dca645a70",
        "  https://www.googleapis.com/robot/v1/metadata/x509/weather-data%40weather-data-429210.iam.gserviceaccount.com",
...
if combined_weather_data:
    ...
    csv_file_path = '/content/drive/My Drive/weather_tomorrow.csv'
    csv_directory = os.path.dirname(csv_file_path)



    # Overwrite the CSV file with the headers and the new data
